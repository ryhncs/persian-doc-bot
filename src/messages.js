...
function helpMessage() {
  const lines = [
    ...
    "🎁 دعوت دوستان: لینک اختصاصیت رو بگیر؛ با هر دوستی که با لینک تو بیاد و اولین درخواستش رو انجام بده، هر دوتون درخواست رایگان اضافه می‌گیرید و با هر ۳ دعوت موفق یه کوپن ۲۰٪ تخفیف اشتراک برات جمع می‌شه.",
    "📝 هر متنی هم که بفرستی، یه فایل Word مرتب و راست‌به‌چپ برات می‌سازم.",
    "🔊 زیر خلاصه‌ی پیام صوتی و PDF یه دکمه‌ی «دریافت نسخه صوتی» هست که خلاصه رو به‌صورت پیام صوتی برات می‌فرسته (هر بار یه درخواست حساب می‌شه).",
    "",
    "نکته‌ها:",
